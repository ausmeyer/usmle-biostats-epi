...
ggplot(data.frame(data = norm), aes(data)) + 
  ...
  annotate("text", x = -10, y = 900, label = "68.3% CI ~ Mean +- 1 SD", size=6, hjust = 0) +
  annotate("text", x = -10, y = 850, label = "95.5% CI ~ Mean +- 2 SD", size=6, hjust = 0) +
  annotate("text", x = -10, y = 800, label = "99.7% CI ~ Mean +- 3 SD", size=6, hjust = 0)
```
